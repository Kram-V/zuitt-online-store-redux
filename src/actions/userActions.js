  ...
  (name, email, password, confirmPassword) => async (dispatch) => {
    try {
      ...
      const response = await axios.post(
        "https://zuitt-online-store.herokuapp.com/api/users/register",
        inputData,
        config
      );
...
export const login = (email, password) => async (dispatch) => {
  try {
    ...
    const response = await axios.post(
      "https://zuitt-online-store.herokuapp.com/api/users/login",
      inputData,
      config
    );
...
export const getUserDetails = () => async (dispatch, getState) => {
  try {
    ...
    const response = await axios.get(
      "https://zuitt-online-store.herokuapp.com/api/users/profile",
      config
    );
...
export const getAllUsers = () => async (dispatch, getState) => {
  try {
    ...
    const response = await axios.get(
      "https://zuitt-online-store.herokuapp.com/api/users",
      config
    );
  ...
  (name, email, password, confirmPassword) => async (dispatch, getState) => {
    try {
      ...
      const response = await axios.put(
        "https://zuitt-online-store.herokuapp.com/api/users/update/profile",
        inputData,
        config
      );
...
export const deleteUserByAdmin = (id) => async (dispatch, getState) => {
  try {
    ...
    const response = await axios.delete(
      `https://zuitt-online-store.herokuapp.com/api/users/delete/${id}`,
      config
    );
...
export const getUserDetailsByAdmin = (id) => async (dispatch, getState) => {
  try {
    ...
    const response = await axios.get(
      `https://zuitt-online-store.herokuapp.com/api/users/${id}`,
      config
    );
