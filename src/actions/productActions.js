  ...
  async (dispatch) => {
    try {
      ...
      const response = await axios.get(
        `https://zuitt-online-store.herokuapp.com/api/products?word=${word}`
      );
...
export const createProduct = (data) => async (dispatch, getState) => {
  try {
    ...
    const response = await axios.post(
      `https://zuitt-online-store.herokuapp.com/api/products`,
      data,
      config
    );
...
export const createProductReview = (id, data) => async (dispatch, getState) => {
  try {
    ...
    const response = await axios.post(
      `https://zuitt-online-store.herokuapp.com/api/products/${id}/review`,
      data,
      config
    );
...
export const getProduct = (id) => async (dispatch) => {
  try {
    ...
    const response = await axios.get(
      `https://zuitt-online-store.herokuapp.com/api/products/${id}`
    );
...
export const getProductDetailsByAdmin = (id) => async (dispatch, getState) => {
  try {
    ...
    const response = await axios.get(
      `https://zuitt-online-store.herokuapp.com/api/products/product/${id}`,
      config
    );
