...
export const createOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const response = await axios.post(
      "https://zuitt-online-store.herokuapp.com/api/orders",
      order,
      config
    );
...
export const orderGet = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      `https://zuitt-online-store.herokuapp.com/api/orders/${id}`,
      config
    );
...
export const payOrder = (id, paymentResult) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `https://zuitt-online-store.herokuapp.com/api/orders/${id}/pay`,
      paymentResult,
      config
    );
...
export const getUserOrders = () => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      `https://zuitt-online-store.herokuapp.com/api/orders/myorders`,
      config
    );
...
export const updateOrderDeliveredByAdmin =
  (id) => async (dispatch, getState) => {
    try {
      ...
      const { data } = await axios.put(
        `https://zuitt-online-store.herokuapp.com/api/orders/${id}/deliver`,
        {},
        config
      );
